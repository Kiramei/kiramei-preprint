...
% =============================================================================
%  Kiramei arXiv paper template --- example document & usage guide.
%
...
\input{template/preamble}   % third-party packages (natbib, booktabs, listings, ...)
\input{template/command}    % math shortcuts and theorem-like environments
...
% -----------------------------------------------------------------------------
\title{The Kiramei arXiv Paper Template:\\ Formatting Instructions and Usage Guide}

\runningtitle{The Kiramei arXiv Paper Template --- Usage Guide}

% -----------------------------------------------------------------------------
%  Optional metadata. Any of these may be left out.
% -----------------------------------------------------------------------------
\keywords{Kiramei template, \LaTeX{}, arXiv preprint, formatting instructions}

% -----------------------------------------------------------------------------
%  A small Kiramei affiliation marker used as a superscript next to author names.
%  Change or remove it freely --- it is just an ordinary \newcommand.
% -----------------------------------------------------------------------------
\newcommand{\affmark}[1]{%
  \textsuperscript{%
    {\usefont{T1}{pbk}{m}{n}\textcolor{BgPrimary600}{\textbf{#1}}}%
  }%
}
...
% -----------------------------------------------------------------------------
\author{Kiramei Lu\affmark{1}, San Zhang\affmark{†}\\
\affmark{1}College of Electronics and Information Engineering, Shenzhen University\\
{\footnotesize\affmark{†}Corresponding author}\\
\faGithub~\textbf{Source Code:} \href{https://github.com/Kiramei/Kiramei}{\monobold{https://github.com/Kiramei/Kiramei}}
}
...
\vspace{-1mm}
\section*{Abstract}
This document is both a working example and a usage guide for the Kiramei arXiv
...
(\texttt{template/style.cls}, \texttt{template/preamble.tex}, and \texttt{template/command.tex})
...
consistent, Kiramei-branded appearance. This template is a Kiramei-styled adaptation of
...
Section~\ref{sec:extras} documents features specific to this Kiramei template, and
...
\begin{itemize}
  ...
  \item \verb+style.cls+ --- the document class. It sets the fonts, colors,
  ...
  \item \verb+figures/+ --- image assets, including \verb+kiramei_logo.png+ used by
...
\begin{itemize}
  ...
  \item \verb+twocolumn+ --- switch to a two-column layout (single column by
    default).
  \item \verb+logo+ --- print \verb+figures/kiramei_logo.png+ in the top-left of the
    first page.
...
\verb+\\+. The \verb+\affmark+ command defined in the preamble produces the small
superscript marker used to tie authors to their affiliation; it is an
...
The title is set in Kiramei purple, bold, and centered inside a rounded box at the top
...
% =============================================================================
\section{Extra features of the Kiramei template}
\label{sec:extras}
% =============================================================================
...
On the first page, the \verb+logo+ option prints the Kiramei logo in the top-left
...
User: Summarize the Kiramei arXiv template in one sentence.
Assistant: It is a Kiramei-branded article class that fixes fonts, colors, and
...
the paper before the references. This Kiramei template adapts the UC~Berkeley RAIL
...
{\raggedright
\bibliography{main}
\bibliographystyle{template/abbrvnat}
}
